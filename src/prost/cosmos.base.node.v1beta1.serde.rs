...
impl serde::Serialize for ConfigResponse {
        ...
        S: serde::Serializer,
    {
        ...
        if true {
            ...
            struct_ser.serialize_field("haltHeight", ::alloc::string::ToString::to_string(&self.halt_height).as_str())?;
        }
        struct_ser.end()
    }
}
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "pruningKeepRecent" | "pruning_keep_recent" => Ok(GeneratedField::PruningKeepRecent),
                            "pruningInterval" | "pruning_interval" => Ok(GeneratedField::PruningInterval),
...
impl serde::Serialize for StatusRequest {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("cosmos.base.node.v1beta1.StatusRequest", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for StatusRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("cosmos.base.node.v1beta1.StatusRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for StatusResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cosmos.base.node.v1beta1.StatusResponse", len)?;
        if true {
            #[allow(clippy::needless_borrow)]
            struct_ser.serialize_field("earliestStoreHeight", ::alloc::string::ToString::to_string(&self.earliest_store_height).as_str())?;
        }
        if true {
            #[allow(clippy::needless_borrow)]
        ...
        if true {
            #[allow(clippy::needless_borrow)]
            struct_ser.serialize_field("validatorHash", pbjson::private::base64::encode(&self.validator_hash).as_str())?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for StatusResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::Deserialize<'de> for GeneratedField {
                ...
                D: serde::Deserializer<'de>,
            {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                    ...
                    {
                        match value {
                            "earliestStoreHeight" | "earliest_store_height" => Ok(GeneratedField::EarliestStoreHeight),
                    ...
                    match k {
                        GeneratedField::EarliestStoreHeight => {
                            if earliest_store_height__.is_some() {
                                return Err(serde::de::Error::duplicate_field("earliestStoreHeight"));
                            }
                            earliest_store_height__ = 
                                Some(map_.next_value::<::pbjson::private::NumberDeserialize<_>>()?.0)
                            ;
                        }
        ...
        deserializer.deserialize_struct("cosmos.base.node.v1beta1.StatusResponse", FIELDS, GeneratedVisitor)
    }
}
