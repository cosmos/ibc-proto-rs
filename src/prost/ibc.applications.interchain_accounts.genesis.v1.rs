...
impl ::prost::Name for GenesisState {
    ...
    fn full_name() -> ::prost::alloc::string::String {
        "ibc.applications.interchain_accounts.genesis.v1.GenesisState".into()
    }
...
impl ::prost::Name for ControllerGenesisState {
    ...
    const PACKAGE: &'static str = "ibc.applications.interchain_accounts.genesis.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "ibc.applications.interchain_accounts.genesis.v1.ControllerGenesisState".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/ibc.applications.interchain_accounts.genesis.v1.ControllerGenesisState".into()
    }
...
impl ::prost::Name for HostGenesisState {
    ...
    const PACKAGE: &'static str = "ibc.applications.interchain_accounts.genesis.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "ibc.applications.interchain_accounts.genesis.v1.HostGenesisState".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/ibc.applications.interchain_accounts.genesis.v1.HostGenesisState".into()
    }
...
impl ::prost::Name for ActiveChannel {
    ...
    const PACKAGE: &'static str = "ibc.applications.interchain_accounts.genesis.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "ibc.applications.interchain_accounts.genesis.v1.ActiveChannel".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/ibc.applications.interchain_accounts.genesis.v1.ActiveChannel".into()
    }
